 ...
 * generated in the edu.lion.students package. 
...
public class ObjectFactory {
    ...
    private final static QName _UpdateStudentResponse_QNAME = new QName("http://students.lion.edu/", "updateStudentResponse");
    private final static QName _UpdateStudent_QNAME = new QName("http://students.lion.edu/", "updateStudent");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.lion.students
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://students.lion.edu/", name = "updateStudentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://students.lion.edu/", name = "updateStudent")
